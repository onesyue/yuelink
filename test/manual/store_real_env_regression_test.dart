...
void main() {
  ...
  test(
    'runs R1-R5 against real XBoard store environment',
    () async {
      ...
      final orderCountBeforeReuse = (await repo.fetchOrders(page: 1)).orders.length;
      launcher.clear();
      notifier.reset();
      await notifier.purchase(planId: 3, period: PlanPeriod.monthly, methodId: 1);
      ...
      final orderCountAfterReuse = (await repo.fetchOrders(page: 1)).orders.length;
